  ...
  void showSetVideoQa() {
    ...
    showDialog(
        ...
        builder: (context) {
          return SelectDialog(
            title: '选择画质',
            values: videoFormat.map((e) => (e, e.newDesc!)).toList(),
            value: videoFormat.firstWhere(
                (element) => element.quality == currentVideoQa.code),
  ...
  void showSetAudioQa() {
    ...
    showDialog(
      ...
      builder: (context) {
        return SelectDialog(
          title: '选择音质',
          values: audio.map((e) => (e, e.quality)).toList(),
          value: audio.firstWhere((element) => element.id == currentAudioQa.code),
          onChanged: (item) async {
            Get.back();
    ...
    showDialog(
      ...
      builder: (context) {
        return SelectDialog(
          title: '选择解码格式',
          values: list
              .map((e) => (e, VideoDecodeFormatType.fromString(e).description))
              .toList(),
          value: list.firstWhere((element) =>
              currentDecodeFormats.codes.any(element.startsWith)),
          onChanged: (item) {
            Get.back();
            final format =
  ...
  void showSetRepeat() {
    showDialog(
      ...
      builder: (context) {
        return SelectDialog(
          title: '选择播放顺序',
          values: PlayRepeat.values.map((e) => (e, e.desc)).toList(),
