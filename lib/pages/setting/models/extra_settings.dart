                  ...
                  content: Column(
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        dense: true,
                        title:
                            const Text('重置', style: TextStyle(fontSize: 14)),
                      ),
                      ListTile(
                        onTap: () async {
                          Get.back();
                          ...
                          Get.find<DownloadService>().initDownloadList();
                          GStorage.setting
                              .put(SettingBoxKey.downloadPath, path);
                        },
                        dense: true,
                        title: const Text('设置新路径',
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      pgcSkipType.title,
                      style:
                          TextStyle(fontSize: 14, height: 1, color: color),
        ...
        SettingsModel(
          ...
          getSubtitle: () {
            final audioNormalization =
                AudioNormalization.getTitleFromConfig(
                  ...
                  content: SingleChildScrollView(
                    child: RadioGroup(
                      onChanged: (value) {
                        Get.back();
                        GStorage.setting
                            .put(SettingBoxKey.quickFavId, value);
          ...
          MemberTabType? result = await showDialog(
            ...
            builder: (context) {
              return SelectDialog<MemberTabType>(
                ...
                values:
                    MemberTabType.values.map((e) => (e, e.title)).toList(),
              );
            },
          );
          if (result != null) {
