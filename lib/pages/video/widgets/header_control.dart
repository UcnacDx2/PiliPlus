              ...
              children: [
                ...
                if (!isFileSource) ...[
                  ListTile(
                    ...
                    onTap: () {
                      Get.back();
                      videoDetailCtr.showSetVideoQa(context);
                    },
                  ...
                  if (videoDetailCtr.currentAudioQa != null)
                    ListTile(
                      ...
                      onTap: () {
                        Get.back();
                        videoDetailCtr.showSetAudioQa(context);
                      },
                ...
                ListTile(
                  ...
                  onTap: () {
                    Get.back();
                    videoDetailCtr.showSetRepeat(context);
                  },
                ...
                ListTile(
                  ...
                  onTap: () {
                    Get.back();
                    videoDetailCtr.showSetDanmaku(context);
                  },
                ...
                ListTile(
                  ...
                  onTap: () {
                    Get.back();
                    videoDetailCtr.showSetSubtitle(context);
                  },
