...
class _DanmakuSettingsPanelState extends State<DanmakuSettingsPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    void updateLineHeight(double val) {
      plPlayerController.danmakuLineHeight =
          danmakuLineHeight = double.parse(val.toStringAsFixed(1));
      setState(() {});
      try {
    ...
    void updateDuration(double val) {
      plPlayerController.danmakuDuration =
          danmakuDuration = double.parse(val.toStringAsFixed(1));
      setState(() {});
      try {
        danmakuController?.updateOption(
          danmakuController.option.copyWith(
    ...
    void updateStaticDuration(double val) {
      plPlayerController.danmakuStaticDuration =
          danmakuStaticDuration = double.parse(val.toStringAsFixed(1));
      setState(() {});
      try {
        danmakuController?.updateOption(
          danmakuController.option.copyWith(
    ...
    void updateShowArea(double val) {
      plPlayerController.showArea =
          showArea = double.parse(val.toStringAsFixed(1));
      setState(() {});
      try {
        danmakuController?.updateOption(
