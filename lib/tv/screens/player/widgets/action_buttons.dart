...
class _ActionButtonsState extends State<ActionButtons> {
  ...
  Future<void> _loadStatus() async {
    ...
    final results = await Future.wait([
      TvBilibiliFacade.checkLikeStatus(widget.aid),
      TvBilibiliFacade.checkCoinStatus(widget.aid),
      TvBilibiliFacade.checkFavoriteStatus(widget.aid),
    ]);
  ...
  Future<void> _onLike() async {
    ...
    final success = await TvBilibiliFacade.likeVideo(
      aid: widget.aid,
      like: !_isLiked,
    );
  ...
  Future<void> _onCoin() async {
    ...
    final error = await TvBilibiliFacade.coinVideo(aid: widget.aid, count: 1);
  ...
  Future<void> _onFavorite() async {
    ...
    final success = await TvBilibiliFacade.favoriteVideo(
      aid: widget.aid,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            _buildButton(
              index: 0,
              svgPath: 'assets/tv_icons/like.svg',
            ...
            _buildButton(
              index: 1,
              svgPath: 'assets/tv_icons/coin.svg',
            ...
            _buildButton(
              index: 2,
              svgPath: 'assets/tv_icons/favorite.svg',
