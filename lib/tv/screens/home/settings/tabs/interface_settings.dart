...
class _InterfaceSettingsState extends State<InterfaceSettings> {
  ...
  void _loadCategoryOrder() {
    _categoryOrder = TvSettingsFacade.categoryOrder;
    ...
    _liveCategoryOrder = TvSettingsFacade.liveCategoryOrder;
  ...
  Widget build(BuildContext context) {
    ...
    final enabledOrder = _categoryOrder
        .where((name) => TvSettingsFacade.isCategoryEnabled(name))
        .toList();
    ...
    return Column(
      ...
      children: [
        ...
        SettingToggleRow(
          ...
          value: TvSettingsFacade.splashAnimationEnabled,
          autofocus: true,
          isFirst: true, // 第一项，向上返回分类标签
          onMoveUp: widget.onMoveUp,
          sidebarFocusNode: widget.sidebarFocusNode,
          onChanged: (value) async {
            await TvSettingsFacade.setSplashAnimationEnabled(value);
            setState(() {});
          },
        ),
        ...
        SettingToggleRow(
          ...
          value: TvSettingsFacade.alwaysShowPlayerTime,
          autofocus: false,
          onMoveUp: null, // 允许自然向上导航到上一项
          sidebarFocusNode: widget.sidebarFocusNode,
          onChanged: (value) async {
            await TvSettingsFacade.setAlwaysShowPlayerTime(value);
            setState(() {});
          },
        ),
        const SizedBox(height: 16),
        ...
        SettingToggleRow(
          ...
          value: TvSettingsFacade.useFirstFrameAsCover,
          autofocus: false,
          onChanged: (value) async {
            await TvSettingsFacade.setUseFirstFrameAsCover(value);
            setState(() {});
          },
        ),
        const SizedBox(height: 16),
        ...
        SizedBox(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final isEnabled = TvSettingsFacade.isCategoryEnabled(catName);
              ...
              return TvFocusScope(
                ...
                onSelect: () {
                  TvSettingsFacade.toggleCategory(catName, !isEnabled);
                  setState(() {});
                },
                child: Builder(
                  builder: (context) {
                      ...
                      onKeyEvent: (node, event) {
                        ...
                        if (_isDragging) {
                          ...
                          if (event.logicalKey ==
                            ...
                            TvSettingsFacade.setCategoryOrder(_categoryOrder);
                            // 焦点跟随到新位置
        ...
        SizedBox(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final label =
                  TvSettingsFacade.liveCategoryLabels[catKey] ?? catKey;
              final isEnabled = TvSettingsFacade.isLiveCategoryEnabled(catKey);

              return TvFocusScope(
                pattern: FocusPattern.horizontal,
                focusNode: _liveCategoryToggleFocusNodes[index],
                onSelect: () {
                  TvSettingsFacade.toggleLiveCategory(catKey, !isEnabled);
                  setState(() {});
                },
                child: Builder(
                  builder: (context) {
        ...
        SizedBox(
          ...
          child:
              _categoryOrder
                  .where((name) => TvSettingsFacade.isLiveCategoryEnabled(name))
                  .isEmpty
              ? Center(
                  child: Text(
                    '请至少启用一个分区',
              ...
              : Builder(
                  builder: (context) {
                    final enabledLiveOrder = _liveCategoryOrder
                        .where(
                          (name) => TvSettingsFacade.isLiveCategoryEnabled(name),
                        )
                        .toList();
                    return ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final label =
                            TvSettingsFacade.liveCategoryLabels[catKey] ??
                            catKey;
                        final isSelected =
                          ...
                          onKeyEvent: (node, event) {
                            ...
                            if (_isLiveDragging) {
                              ...
                              if (event.logicalKey ==
                                ...
                                TvSettingsFacade.setLiveCategoryOrder(
                                  _liveCategoryOrder,
                                );
