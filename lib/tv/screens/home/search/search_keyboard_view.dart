...
import 'package:PiliPlus/tv/adapters/search_history_facade.dart';
...
class _SearchKeyboardViewState extends State<SearchKeyboardView> {
  ...
  void initState() {
    super.initState();
    SearchHistoryFacade.init(); // Initialize history
  }
  ...
  void _handleKeyboardTap(String key) {
    if (key == '后退') {
      ...
      if (_searchText.trim().isNotEmpty) {
        SearchHistoryFacade.add(_searchText.trim());
      }
  ...
  Future<void> _fetchSuggestions() async {
    ...
    final suggestions = await TvBilibiliFacade.getSearchSuggestions(_searchText);
  ...
  void _selectSuggestion(String suggestion) {
    ...
    SearchHistoryFacade.add(suggestion);
  ...
  Widget _buildSuggestions() {
    ...
    if (_suggestions.isEmpty) {
      final history = SearchHistoryFacade.getAll();
      if (history.isEmpty) {
        return Center(
          child: Column(
                  ...
                  if (index == history.length) {
                    ...
                    return Padding(
                      ...
                      child: _SuggestionItem(
                        ...
                        onTap: () async {
                          await SearchHistoryFacade.clear();
                          setState(() {});
                        },
                        onBack: widget.onBackToHome,
                      ),
