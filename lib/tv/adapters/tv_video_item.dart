...
class TvVideoItem {
  ...
  /// 从推荐/热门 API 响应解析
  factory TvVideoItem.fromRecommend(Map<String, dynamic> json) {
  ...
  /// 从历史记录 API 响应解析
  factory TvVideoItem.fromHistory(Map<String, dynamic> json) {
  ...
  /// 从搜索结果解析
  factory TvVideoItem.fromSearch(Map<String, dynamic> json) {
